...
$c_Lcalculator_Polynomial$$anonfun$computeSolutions$1.prototype.apply__sci_Set = (function() {
  if (($uD(this.delta$1$f.apply__O()) >= 0)) {
    var array = [1, (-1)];
    ...
    var this$4 = $as_sc_SetLike(jsx$1);
    var f = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(arg$outer) {
      return (function(i$2) {
        var i$1 = $uI(i$2);
        var jsx$2 = $uD(arg$outer.b$2$f.apply__O());
        var a = $uD(arg$outer.delta$1$f.apply__O());
        return (((-jsx$2) + (i$1 * $uD($g.Math.sqrt(a)))) / (2 * $uD(arg$outer.a$2$f.apply__O())))
      })
    })(this));
    var this$3 = $m_sci_Set$();
    var bf = new $c_scg_GenSetFactory$$anon$1().init___scg_GenSetFactory(this$3);
    return $as_sci_Set($s_sc_TraversableLike$class__map__sc_TraversableLike__F1__scg_CanBuildFrom__O(this$4, f, bf)).toSet__sci_Set()
  } else {
